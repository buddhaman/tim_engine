...
evodraw_win: $(OBJ_WIN)
	$(CC_WIN) src/main.c -lm -o evodraw_win externalWin.o -g -Iinclude_chipmunk -Iinclude -I../SDL2mingw/include -L../SDL2mingw/lib -Wall \
...
external_win: 
	$(CC_WIN) src/external_libs.c -c -lm -o externalWin.o -g -O3 -Iinclude_chipmunk -Iinclude -I../SDL2mingw/include \
		-L../SDL2/lib -Wall 
